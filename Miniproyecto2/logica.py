...
informacion = ['hay mina en', 'hay 1 mina alrededor de', 'hay 2 minas alrededor de', 'hay 3 minas alrededor de', 'hay 4 minas alrededor de', 'hay 5 minas alrededor de']
#filas = [str(i) for i in range(nfilas)]
#columnas = [str(i) for i in range(ncolumnas)]
